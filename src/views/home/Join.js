  ...
  return (
    <JoinContainer>
      <Container>
        ...
        <UsersContainer>
          <div>
            <Image src={person1} alt="review" width={60} height={60} className="rounded-full" />
          </div>
          <div>
          <Image src={person2} alt="review" width={60} height={60} className="rounded-full" />
          </div>
          <div>
          <Image src={person3} alt="review" width={60} height={60} className="rounded-full" />
          </div>
        </UsersContainer>
        <p>
          ...
          <Grid container spacing={2}>
            <Grid item xs={12} md={6}>
              ...
              <p>
                ...
                autism. Results and action plan are generated in under 5
